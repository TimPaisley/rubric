		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('fa fa-user fa-lg fa-fw')
						]),
					_List_Nil)
				]));
	};
	return A2(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					A2(elm$core$List$map, displayQuestion, testQuestions),
					_List_fromArray(
						[
							A2(
							elm$html$Html$input,
